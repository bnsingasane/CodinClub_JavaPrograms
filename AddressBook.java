...
class Details
{
	...
	public Details(String firstName, String lastName, String address, String city, String state, int zipcode, long mobileNo)
	{
		this.firstName=firstName;
		this.lastName=lastName;
		this.address=address;
	    	 ...
	    	 switch(ch)
	    	 {
	     		case 1:
	     			...
	     			for(int i=0;i<n;i++)
	     			{
	     				...
	     				a[count]=new Details(firstName,lastName,address,city,state,zipcode,mobileNo);
	     				count++;
	     			}
